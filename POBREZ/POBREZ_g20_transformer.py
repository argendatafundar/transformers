...
pipeline = chain(
	...
	replace_value(col='categoria', mapping={'old_and_child': 'Adultos mayores y niños', 'old_and_old': 'Adultos mayores', 'child_no_siblings': 'Niños sin hermanos', 'child_1_sibling': 'Niños con 1 hermano', 'child_2more_siblings': 'Niños con 2 o más hermanos'}, alias=None)
)
#  PIPELINE_END
