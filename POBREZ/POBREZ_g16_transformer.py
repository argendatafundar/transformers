...
pipeline = chain(
	...
	replace_value(col='labor_status', mapping={'CtaPropia_no_Profesional': 'Cuenta propia no profesional', 'CtaPropia_Profesional': 'Cuenta propia profesional', 'Asalariado_Informal': 'Asalariado informal', 'Asalariado_Formal': 'Asalariado formal', 'Patrones': 'Patrón'}, alias=None),
