...
replace_value(col='semester', curr_value='I', new_value=1),
	...
	replace_value(col='labor_status', curr_value='CtaPropia_no_Profesional', new_value='Cuenta propia no profesional'),
	replace_value(col='labor_status', curr_value='CtaPropia_Profesional', new_value='Cuenta propia profesional'),
	replace_value(col='labor_status', curr_value='Asalariado_Informal', new_value='Asalariado informal'),
	replace_value(col='labor_status', curr_value='Asalariado_Formal', new_value='Asalariado formal'),
	replace_value(col='labor_status', curr_value='Patrones', new_value='Patrón'),
	...
	query(condition="categoria != 'Ocupados' & categoria != 'Desocupados' & categoria != 'Inactivos' & categoria != 'Sin_Salario' & categoria != 'Total'")
)
#  PIPELINE_END
