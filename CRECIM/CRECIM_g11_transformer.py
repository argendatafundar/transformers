...
drop_col(col='continente_fundar', axis=1),
	...
	rename_cols(map={'iso3': 'geoselector', 'pib_per_capita': 'valor'}),
	replace_value(col='geoselector', curr_value='WRL_MPD', new_value='WLD')
)
#  PIPELINE_END
...
#   #   Column       Non-Null Count  Dtype  
#  ---  ------       --------------  -----  
#   0   geoselector  21618 non-null  object 
#   1   anio         21618 non-null  int64  
