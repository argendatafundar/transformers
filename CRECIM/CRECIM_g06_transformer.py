...
#  ---  ------             --------------  -----  
#   0   iso3               7662 non-null   object 
#   1   continente_fundar  6095 non-null   object 
#   2   anio               7662 non-null   int64  
#   3   pib_pc             7662 non-null   float64
#   4   nivel_agregacion   7662 non-null   object 
#  
#  |    | iso3   | continente_fundar                      |   anio |   pib_pc | nivel_agregacion   |
#  |---:|:-------|:---------------------------------------|-------:|---------:|:-------------------|
#  |  0 | ABW    | América del Norte, Central y el Caribe |   1990 |  30823.5 | pais               |
#  
#  ------------------------------
#  
#  drop_col(col='continente_fundar', axis=1)
...
#   3   nivel_agregacion  7662 non-null   object 
#  
#  |    | iso3   |   anio |   pib_pc | nivel_agregacion   |
#  |---:|:-------|-------:|---------:|:-------------------|
#  |  0 | ABW    |   1990 |  30823.5 | pais               |
#  
#  ------------------------------
#  
#  drop_col(col='nivel_agregacion', axis=1)
