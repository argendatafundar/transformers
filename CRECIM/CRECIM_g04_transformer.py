...
#   3   promedio                17 non-null     float64
#   4   nivel_agregacion        17 non-null     object 
#  
#  |    | iso3   | continente_fundar   |   pib_percapita_ppp_2017 |   promedio | nivel_agregacion   |
#  |---:|:-------|:--------------------|-------------------------:|-----------:|:-------------------|
#  | 39 | ARM    | Asia                |                  4522.32 |       7.78 | pais               |
#  
#  ------------------------------
#  
#  rename_cols(map={'iso3': 'geocodigo', 'continente_fundar': 'grupo', 'medida_bienestar': 'indicador'})
...
#   #   Column     Non-Null Count  Dtype 
#  ---  ------     --------------  ----- 
#   0   geocodigo  51 non-null     object
#   1   grupo      51 non-null     object
#   2   indicador  51 non-null     object
#   3   valor      51 non-null     object
#  
#  |    | geocodigo   | grupo   | indicador              |   valor |
#  |---:|:------------|:--------|:-----------------------|--------:|
#  |  0 | ARM         | Asia    | pib_percapita_ppp_2017 | 4522.32 |
#  
#  ------------------------------
#  