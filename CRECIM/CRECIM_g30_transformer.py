...
#  PIPELINE_START
pipeline = chain(
	query(condition='geonombreFundar in ["Argentina", "Venezuela", "Chile", "Brasil","México", "América Latina", "Uruguay"]'),
...
#  
#  query(condition='geonombreFundar in ["Argentina", "Venezuela", "Chile", "Brasil","México", "América Latina", "Uruguay"]')
#  Index: 1040 entries, 0 to 7824
#  Data columns (total 5 columns):
#   #   Column           Non-Null Count  Dtype  
#  ---  ------           --------------  -----  
#   0   geocodigoFundar  1040 non-null   object 
#   1   geonombreFundar  1040 non-null   object 
#   2   anio             1040 non-null   int64  
#   3   pib_per_capita   1040 non-null   float64
#   4   cambio_relativo  1040 non-null   float64
#  
#  |    | geocodigoFundar   | geonombreFundar   |   anio |   pib_per_capita |   cambio_relativo |
#  |---:|:------------------|:------------------|-------:|-----------------:|------------------:|
#  |  0 | ARG               | Argentina         |   1820 |             1591 |                 0 |
...
#   #   Column           Non-Null Count  Dtype  
#  ---  ------           --------------  -----  
#   0   geonombreFundar  1040 non-null   object 
#   1   anio             1040 non-null   int64  
#   2   cambio_relativo  1040 non-null   float64
#  
