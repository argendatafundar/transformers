...
#   #   Column           Non-Null Count  Dtype   
#  ---  ------           --------------  -----   
#   0   geonombreFundar  218 non-null    category
#   1   sector           218 non-null    category
#   2   valor            218 non-null    float64 
#  
#  |     | geonombreFundar   | sector                         |   valor |
#  |----:|:------------------|:-------------------------------|--------:|
#  | 159 | Israel            | Empresas (Públicas y Privadas) | 93.0072 |
#  
#  ------------------------------
#  
#  completar_combinaciones(keys=['geonombreFundar', 'sector'])
...
#  |    | geonombreFundar   | sector                         |   valor |
#  |---:|:------------------|:-------------------------------|--------:|
#  |  0 | Israel            | Empresas (Públicas y Privadas) | 93.0072 |
#  
#  ------------------------------
#  
#  fill_na(col='valor', fill=0)
