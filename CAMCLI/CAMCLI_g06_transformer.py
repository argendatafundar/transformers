...
wide_to_long(primary_keys=['sector', 'anio', 'subsector'], value_name='valor', var_name='indicador'),
	...
	query(condition="indicador == 'valor_en_porcent'")
)
#  PIPELINE_END
...
#  |---:|:---------|-------:|:---------------------------------|:----------------|--------:|
#  |  0 | AGSyOUT  |   2018 | Emisiones de la quema de biomasa | valor_en_mtco2e | 4.52477 |
#  
#  ------------------------------
#  
#  rename_cols(map={'sector': 'nivel1', 'subsector': 'nivel2'})
...
#   1   anio       15 non-null     int64  
#   2   nivel2     15 non-null     object 
#   3   indicador  15 non-null     object 
#   4   valor      15 non-null     float64
#  
#  |    | nivel1   |   anio | nivel2                           | indicador        |   valor |
#  |---:|:---------|-------:|:---------------------------------|:-----------------|--------:|
#  | 15 | AGSyOUT  |   2018 | Emisiones de la quema de biomasa | valor_en_porcent | 1.23665 |
#  
#  ------------------------------
#  