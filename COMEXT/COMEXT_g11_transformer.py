...
pipeline = chain(
	...
	rename_cols(map={'year': 'anio', 'sitc_product_name_es': 'indicador', 'import_value_pc': 'valor'}),
...
#   6   import_value_pc         122360 non-null  float64
#  
#  |    | geocodigoFundar   | geonombreFundar   |   year | location_name_short_en   |   sitc_2_1_cod | sitc_product_name_es   |   import_value_pc |
#  |---:|:------------------|:------------------|-------:|:-------------------------|---------------:|:-----------------------|------------------:|
#  |  0 | AFG               | Afganistán        |   1962 | Afghanistan              |              0 | Productos alimenticios |           7.95848 |
#  
#  ------------------------------
#  
#  query(condition='geocodigoFundar == "ARG"')
...
#   6   import_value_pc         600 non-null    float64
#  
#  |    | geocodigoFundar   | geonombreFundar   |   year | location_name_short_en   |   sitc_2_1_cod | sitc_product_name_es   |   import_value_pc |
#  |---:|:------------------|:------------------|-------:|:-------------------------|---------------:|:-----------------------|------------------:|
#  | 50 | ARG               | Argentina         |   1962 | Argentina                |              0 | Productos alimenticios |           2.94598 |
#  
#  ------------------------------
#  
#  drop_col(col='geocodigoFundar', axis=1)
...
#   5   import_value_pc         600 non-null    float64
#  
#  |    | geonombreFundar   |   year | location_name_short_en   |   sitc_2_1_cod | sitc_product_name_es   |   import_value_pc |
#  |---:|:------------------|-------:|:-------------------------|---------------:|:-----------------------|------------------:|
#  | 50 | Argentina         |   1962 | Argentina                |              0 | Productos alimenticios |           2.94598 |
#  
#  ------------------------------
#  
#  drop_col(col='location_name_short_en', axis=1)
...
#   4   import_value_pc       600 non-null    float64
#  
#  |    | geonombreFundar   |   year |   sitc_2_1_cod | sitc_product_name_es   |   import_value_pc |
#  |---:|:------------------|-------:|---------------:|:-----------------------|------------------:|
#  | 50 | Argentina         |   1962 |              0 | Productos alimenticios |           2.94598 |
#  
#  ------------------------------
#  
#  drop_col(col='sitc_2_1_cod', axis=1)
...
#   3   import_value_pc       600 non-null    float64
#  
#  |    | geonombreFundar   |   year | sitc_product_name_es   |   import_value_pc |
#  |---:|:------------------|-------:|:-----------------------|------------------:|
#  | 50 | Argentina         |   1962 | Productos alimenticios |           2.94598 |
#  
#  ------------------------------
#  
#  rename_cols(map={'year': 'anio', 'sitc_product_name_es': 'indicador', 'import_value_pc': 'valor'})
...
#  |    | geonombreFundar   |   anio | indicador          |   valor |
#  |---:|:------------------|-------:|:-------------------|--------:|
#  | 50 | Argentina         |   1962 | Prod. alimenticios | 2.94598 |
#  
#  ------------------------------
#  
#  summarize(groupby=['geonombreFundar', 'anio', 'indicador'], columns='valor', operation='sum')
...
#  |    | geonombreFundar   |   anio | indicador          |     valor |
#  |---:|:------------------|-------:|:-------------------|----------:|
#  |  0 | Argentina         |   1962 | Aceites y mantecas | 0.0766724 |
#  
#  ------------------------------
#  