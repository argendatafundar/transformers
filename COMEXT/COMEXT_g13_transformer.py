...
query(condition='iso3 == "ARG"'),
	rename_cols(map={'iso3': 'geocodigo', 'sector_bp_name': 'categoria', 'import_value_pc': 'valor'}),
...
#   5   import_value_pc            2912 non-null   float64
#  
#  |    |   anio | iso3   | country_name_abbreviation   |   sector_bp | sector_bp_name       |   import_value_pc |
#  |---:|-------:|:-------|:----------------------------|------------:|:---------------------|------------------:|
#  |  0 |   2020 | BGD    | Bangladesh                  |           2 | Alimentos procesados |           2.64054 |
#  
#  ------------------------------
#  
#  query(condition='iso3 == "ARG"')
...
#   5   import_value_pc            13 non-null     float64
#  
#  |     |   anio | iso3   | country_name_abbreviation   |   sector_bp | sector_bp_name   |   import_value_pc |
#  |----:|-------:|:-------|:----------------------------|------------:|:-----------------|------------------:|
#  | 477 |   2020 | ARG    | Argentina                   |           6 | Cueros y pieles  |          0.242406 |
#  
#  ------------------------------
#  
#  rename_cols(map={'iso3': 'geocodigo', 'sector_bp_name': 'categoria', 'import_value_pc': 'valor'})
...
#  |----:|-------:|:------------|------------:|:----------------|---------:|
#  | 477 |   2020 | ARG         |           6 | Cueros y pieles | 0.242406 |
#  
#  ------------------------------
#  
#  drop_col(col='sector_bp', axis=1)
...
#  |----:|-------:|:------------|:----------------|---------:|
#  | 477 |   2020 | ARG         | Cueros y pieles | 0.242406 |
#  
#  ------------------------------
#  