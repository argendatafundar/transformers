...
pipeline = chain(
	...
	ordenar_dos_columnas(col1='edad_jefe', order1=['65 o mas', '55 a 64', '35 a 44', '45 a 54', '25 a 34', '24 o menos'], col2='fuente', order2=['Laboral', 'Capital', 'Jubilaciones', 'Transferencias estatales', 'Otros ingresos'])
)
#  PIPELINE_END
...
#  |    |   year |   semestre | edad_jefe   | fuente   |   proporcion |
#  |---:|-------:|-----------:|:------------|:---------|-------------:|
#  |  5 |   2024 |          1 | 65 o mas    | Laboral  |       47.391 |
#  
#  ------------------------------
#  