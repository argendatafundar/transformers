...
regreplace_text(col='campania', pattern='\\d{4}/', replacement=''),
	...
	rename_cols(map={'cultivo': 'categoria', 'supsem_total': 'valor', 'campania': 'anio'})
)
#  PIPELINE_END
...
#   2   supsem_total  162 non-null    float64
#  
#  |    | cultivo   | campania   |   supsem_total |
#  |---:|:----------|:-----------|---------------:|
#  |  0 | Maíz      | 1969/70    |    4.66376e+06 |
#  
#  ------------------------------
#  
#  regreplace_text(col='campania', pattern='\\d{4}/', replacement='')
