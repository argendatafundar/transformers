...
#  |    | iso3   | pais_nombre   |   ncm6 | desc_ncm6                                                                                                |        expo |   share |   ranking |
#  |---:|:-------|:--------------|-------:|:---------------------------------------------------------------------------------------------------------|------------:|--------:|----------:|
#  |  7 | BOL    | Bolivia       | 230400 | Tortas y demás residuos sólidos de la extracción del aceite de soja "soya", incl. molidos o en "pellets" | 1.17763e+06 |   3.277 |         5 |
#  
#  ------------------------------
#  
#  sort_values(how='descending', by='share')
...
#  |    | iso3   | pais_nombre   |   ncm6 | desc_ncm6                                                                                                |        expo |   share |   ranking |
#  |---:|:-------|:--------------|-------:|:---------------------------------------------------------------------------------------------------------|------------:|--------:|----------:|
#  |  0 | BRA    | Brasil        | 230400 | Tortas y demás residuos sólidos de la extracción del aceite de soja "soya", incl. molidos o en "pellets" | 1.15278e+07 |  32.082 |         1 |
#  
#  ------------------------------
#  