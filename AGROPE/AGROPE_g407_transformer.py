...
#  |     | iso3   | pais_nombre   |   ncm6 | desc_ncm6                                           |   expo |   share |   ranking |
#  |----:|:-------|:--------------|-------:|:----------------------------------------------------|-------:|--------:|----------:|
#  | 291 | TGO    | Togo          | 120190 | La soja, incluso quebrantadas, excepto para siembra | 391834 |   0.414 |         9 |
#  
#  ------------------------------
#  
#  sort_values(how='descending', by='share')
...
#  |    | iso3   | pais_nombre   |   ncm6 | desc_ncm6                                           |       expo |   share |   ranking |
#  |---:|:-------|:--------------|-------:|:----------------------------------------------------|-----------:|--------:|----------:|
#  |  0 | BRA    | Brasil        | 120190 | La soja, incluso quebrantadas, excepto para siembra | 5.3584e+07 |  56.656 |         1 |
#  
#  ------------------------------
#  