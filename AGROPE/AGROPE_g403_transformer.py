...
#  |    | iso3   | pais_nombre   |   ncm6 | desc_ncm6                |        expo |   share |   ranking |
#  |---:|:-------|:--------------|-------:|:-------------------------|------------:|--------:|----------:|
#  | 29 | FRA    | Francia       | 100590 | Maíz (exc. para siembra) | 1.13215e+06 |   2.196 |         7 |
#  
#  ------------------------------
#  
#  sort_values(how='descending', by='share')
...
#  |    | iso3   | pais_nombre    |   ncm6 | desc_ncm6                |        expo |   share |   ranking |
#  |---:|:-------|:---------------|-------:|:-------------------------|------------:|--------:|----------:|
#  |  0 | USA    | Estados Unidos | 100590 | Maíz (exc. para siembra) | 1.36377e+07 |  26.449 |         1 |
#  
#  ------------------------------
#  