...
#  |     | iso3   | pais_nombre   |   ncm6 | desc_ncm6                    |   expo |   share |   ranking |
#  |----:|:-------|:--------------|-------:|:-----------------------------|-------:|--------:|----------:|
#  | 214 | ARG    | Argentina     | 100390 | Cebada, excepto para siembra | 959097 |   8.554 |         4 |
#  
#  ------------------------------
#  
#  sort_values(how='descending', by='share')
...
#  |    | iso3   | pais_nombre   |   ncm6 | desc_ncm6                    |        expo |   share |   ranking |
#  |---:|:-------|:--------------|-------:|:-----------------------------|------------:|--------:|----------:|
#  |  0 | AUS    | Australia     | 100390 | Cebada, excepto para siembra | 2.31783e+06 |  20.672 |         1 |
#  
#  ------------------------------
#  