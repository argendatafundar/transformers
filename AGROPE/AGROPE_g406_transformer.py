...
#  |    | iso3   | pais_nombre   |   ncm6 | desc_ncm6                |        expo |   share |   ranking |
#  |---:|:-------|:--------------|-------:|:-------------------------|------------:|--------:|----------:|
#  | 79 | IND    | India         |  30617 | Otros gambas, congelados | 4.43673e+06 |  22.366 |         2 |
#  
#  ------------------------------
#  
#  sort_values(how='descending', by='share')
...
#  |    | iso3   | pais_nombre   |   ncm6 | desc_ncm6                |        expo |   share |   ranking |
#  |---:|:-------|:--------------|-------:|:-------------------------|------------:|--------:|----------:|
#  |  0 | ECU    | Ecuador       |  30617 | Otros gambas, congelados | 6.98658e+06 |  35.221 |         1 |
#  
#  ------------------------------
#  