...
#   1   pp_sin_mineria              33 non-null     float64
#   2   moa                         33 non-null     float64
#   3   participacion_expo_totales  33 non-null     float64
#  
#  |    |   anio |   pp_sin_mineria |     moa |   participacion_expo_totales |
#  |---:|-------:|-----------------:|--------:|-----------------------------:|
#  |  0 |   1992 |          3474.69 | 4837.11 |                     0.679349 |
#  
#  ------------------------------
#  
#  drop_col(col=['participacion_expo_totales'], axis=1)
...
#   2   moa             33 non-null     float64
#  
#  |    |   anio |   pp_sin_mineria |     moa |
#  |---:|-------:|-----------------:|--------:|
#  |  0 |   1992 |          3474.69 | 4837.11 |
#  
#  ------------------------------
#  
#  pivot_longer(id_cols=['anio'], names_to_col='sector', values_to_col='valor')
...
#  |    |   anio | sector              |   valor |
#  |---:|-------:|:--------------------|--------:|
#  |  0 |   1992 | Productos primarios | 3474.69 |
#  
#  ------------------------------
#  
#  replace_value(col='sector', curr_value='moa', new_value='MOA')
