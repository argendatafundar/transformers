...
#  |    | iso3   | pais_nombre   |   ncm6 | desc_ncm6                              |   expo |   share |   ranking |
#  |---:|:-------|:--------------|-------:|:---------------------------------------|-------:|--------:|----------:|
#  | 40 | HUN    | Hungría       | 151211 | Aceites de girasol o cártamo, en bruto | 523219 |   4.123 |         6 |
#  
#  ------------------------------
#  
#  sort_values(how='descending', by='share')
...
#  |    | iso3   | pais_nombre   |   ncm6 | desc_ncm6                              |        expo |   share |   ranking |
#  |---:|:-------|:--------------|-------:|:---------------------------------------|------------:|--------:|----------:|
#  |  0 | UKR    | Ucrania       | 151211 | Aceites de girasol o cártamo, en bruto | 4.38048e+06 |  34.521 |         1 |
#  
#  ------------------------------
#  