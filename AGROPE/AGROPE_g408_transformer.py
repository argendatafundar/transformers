...
#  |     | iso3   | pais_nombre   |   ncm6 | desc_ncm6                               |       expo |   share |   ranking |
#  |----:|:-------|:--------------|-------:|:----------------------------------------|-----------:|--------:|----------:|
#  | 146 | BRA    | Brasil        |  20230 | Carne deshuesada, de bovinos, congelada | 8.5032e+06 |  28.157 |         1 |
#  
#  ------------------------------
#  
#  sort_values(how='descending', by='share')
...
#  |    | iso3   | pais_nombre   |   ncm6 | desc_ncm6                               |       expo |   share |   ranking |
#  |---:|:-------|:--------------|-------:|:----------------------------------------|-----------:|--------:|----------:|
#  |  0 | BRA    | Brasil        |  20230 | Carne deshuesada, de bovinos, congelada | 8.5032e+06 |  28.157 |         1 |
#  
#  ------------------------------
#  