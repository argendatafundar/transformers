...
latest_year(by='anio'),
	...
	ordenar_dos_columnas(col1='geocodigo', order1=['SER', 'SOM', 'TUV', 'CPV', 'CSK', 'ETF', 'ANT', 'MHL', 'YMD', 'YM1', 'COK', 'SUV', 'SDN', 'LBR', 'GUY', 'TCD', 'BRN', 'COD', 'SLE', 'PRK', 'AZE', 'IRQ', 'SSD', 'KHM', 'TLS', 'QAT', 'ETH', 'TZA', 'GAB', 'NER', 'MMR', 'MLI', 'GIN', 'PNG', 'AGO', 'SAU', 'UZB', 'SYR', 'BFA', 'IDN', 'TKM', 'GNQ', 'BDI', 'NGA', 'UGA', 'CAF', 'VEN', 'GHA', 'MOZ', 'VNM', 'TJK', 'NOR', 'SUR', 'MNG', 'MRT', 'LAO', 'ZWE', 'COG', 'AFG', 'ARE', 'DZA', 'SLB', 'TTO', 'HTI', 'ZPM', 'OMN', 'RWA', 'MYS', 'ERI', 'BEN', 'MDG', 'NIC', 'PRY', 'CHN', 'BTN', 'COM', 'LBY', 'MWI', 'PRI', 'IRN', 'BGD', 'KWT', 'IND', 'GNB', 'EGY', 'BLR', 'ALB', 'PER', 'CMR', 'PAK', 'IRL', 'BHR', 'THA', 'BOL', 'SWZ', 'SEN', 'XKX', 'LIE', 'KAZ', 'TGO', 'ECU', 'TUR', 'CIV', 'LSO', 'DOM', 'GMB', 'KEN', 'BWA', 'LKA', 'KGZ', 'ZMB', 'HND', 'YEM', 'RUS', 'TON', 'NAM', 'MAR', 'CHL', 'SMR', 'MEX', 'ARM', 'COL', 'NRU', 'PHL', 'NPL', 'SRB', 'ARG', 'ROU', 'KOR', 'GRL', 'TUN', 'BIH', 'CZE', 'POL', 'KIR', 'SVK', 'MKD', 'VUT', 'SVN', 'GTM', 'DMA', 'FJI', 'SLV', 'BGR', 'HUN', 'LTU', 'MDA', 'JAM', 'JOR', 'FIN', 'BRA', 'AUS', 'GEO', 'UKR', 'DEU', 'AUT', 'ZAF', 'LVA', 'JPN', 'EST', 'PAN', 'FSM', 'PSE', 'SWE', 'URY', 'ISL', 'ITA', 'NZL', 'BLZ', 'HRV', 'CAN', 'CRI', 'STP', 'CHE', 'SGP', 'ESP', 'ATG', 'NCL', 'MUS', 'KNA', 'WSM', 'GRD', 'DNK', 'MNE', 'PRT', 'NLD', 'GRC', 'VCT', 'BEL', 'ISR', 'FRA', 'CUB', 'USA', 'GBR', 'LBN', 'MDV', 'SYC', 'BRB', 'MSR', 'TCA', 'PLW', 'CYP', 'PYF', 'MLT', 'CUW', 'LCA', 'DJI', 'AIA', 'AND', 'ABW', 'MCO', 'LUX', 'MAC', 'BHS', 'CYM', 'SXM', 'VGB', 'HKG', 'BMU'], col2='indicador', order2=['Agro y pesca', 'Industria manufacturera', 'Energía y minería', 'Construcción', 'Comercio, hotelería y restaurantes', 'Transporte y comunicaciones', 'Otros servicios'])
)
#  PIPELINE_END
