...
#  PIPELINE_START
pipeline = chain(
    rename_cols(map={'vab_min_vab_total_prov': 'valor', 'provincia': 'geoselector'}),
...
#  ------------------------------
#  
#  rename_cols(map={'vab_min_vab_total_prov': 'valor'})
#  RangeIndex: 475 entries, 0 to 474
#  Data columns (total 3 columns):
#   #   Column     Non-Null Count  Dtype  
#  ---  ------     --------------  -----  
...
#  ------------------------------
#  
#  replace_value(col='provincia', curr_value='Buenos_Aires', new_value='AR-B')
#  RangeIndex: 475 entries, 0 to 474
#  Data columns (total 3 columns):
#   #   Column     Non-Null Count  Dtype  
#  ---  ------     --------------  -----  
...
#  ------------------------------
#  
#  replace_value(col='provincia', curr_value='Ciudad_de_Buenos_Aires', new_value='AR-C')
#  RangeIndex: 475 entries, 0 to 474
#  Data columns (total 3 columns):
#   #   Column     Non-Null Count  Dtype  
#  ---  ------     --------------  -----  
...
#  ------------------------------
#  
#  replace_value(col='provincia', curr_value='Cordoba', new_value='AR-X')
#  RangeIndex: 475 entries, 0 to 474
#  Data columns (total 3 columns):
#   #   Column     Non-Null Count  Dtype  
#  ---  ------     --------------  -----  
...
#  ------------------------------
#  
#  replace_value(col='provincia', curr_value='Entre_Rios', new_value='AR-E')
#  RangeIndex: 475 entries, 0 to 474
#  Data columns (total 3 columns):
#   #   Column     Non-Null Count  Dtype  
#  ---  ------     --------------  -----  
...
#  ------------------------------
#  
#  replace_value(col='provincia', curr_value='La_Pampa', new_value='AR-L')
#  RangeIndex: 475 entries, 0 to 474
#  Data columns (total 3 columns):
#   #   Column     Non-Null Count  Dtype  
#  ---  ------     --------------  -----  
...
#  ------------------------------
#  
#  replace_value(col='provincia', curr_value='La_Rioja', new_value='AR-F')
#  RangeIndex: 475 entries, 0 to 474
#  Data columns (total 3 columns):
#   #   Column     Non-Null Count  Dtype  
#  ---  ------     --------------  -----  
...
#  ------------------------------
#  
#  replace_value(col='provincia', curr_value='Neuquen', new_value='AR-Q')
#  RangeIndex: 475 entries, 0 to 474
#  Data columns (total 3 columns):
#   #   Column     Non-Null Count  Dtype  
#  ---  ------     --------------  -----  
...
#  ------------------------------
#  
#  replace_value(col='provincia', curr_value='Rio_Negro', new_value='AR-R')
#  RangeIndex: 475 entries, 0 to 474
#  Data columns (total 3 columns):
#   #   Column     Non-Null Count  Dtype  
#  ---  ------     --------------  -----  
...
#  ------------------------------
#  
#  replace_value(col='provincia', curr_value='San_Juan', new_value='AR-J')
#  RangeIndex: 475 entries, 0 to 474
#  Data columns (total 3 columns):
#   #   Column     Non-Null Count  Dtype  
#  ---  ------     --------------  -----  
...
#  ------------------------------
#  
#  replace_value(col='provincia', curr_value='San_Luis', new_value='AR-D')
#  RangeIndex: 475 entries, 0 to 474
#  Data columns (total 3 columns):
#   #   Column     Non-Null Count  Dtype  
#  ---  ------     --------------  -----  
...
#  ------------------------------
#  
#  replace_value(col='provincia', curr_value='Santa_Cruz', new_value='AR-Z')
#  RangeIndex: 475 entries, 0 to 474
#  Data columns (total 3 columns):
#   #   Column     Non-Null Count  Dtype  
#  ---  ------     --------------  -----  
...
#  ------------------------------
#  
#  replace_value(col='provincia', curr_value='Santa_Fe', new_value='AR-S')
#  RangeIndex: 475 entries, 0 to 474
#  Data columns (total 3 columns):
#   #   Column     Non-Null Count  Dtype  
#  ---  ------     --------------  -----  
...
#  ------------------------------
#  
#  replace_value(col='provincia', curr_value='Santiago_del_Estero', new_value='AR-G')
#  RangeIndex: 475 entries, 0 to 474
#  Data columns (total 3 columns):
#   #   Column     Non-Null Count  Dtype  
#  ---  ------     --------------  -----  
...
#  ------------------------------
#  
#  replace_value(col='provincia', curr_value='Tierra_del_Fuego', new_value='AR-V')
#  RangeIndex: 475 entries, 0 to 474
#  Data columns (total 3 columns):
#   #   Column     Non-Null Count  Dtype  
#  ---  ------     --------------  -----  
...
#  ------------------------------
#  
#  replace_value(col='provincia', curr_value='Tucuman', new_value='AR-T')
#  RangeIndex: 475 entries, 0 to 474
#  Data columns (total 3 columns):
#   #   Column     Non-Null Count  Dtype  
#  ---  ------     --------------  -----  
...
#  ------------------------------
#  
#  replace_value(col='provincia', curr_value='No_distribuido', new_value='NO-DIST-MINERI')
#  RangeIndex: 475 entries, 0 to 474
#  Data columns (total 3 columns):
#   #   Column     Non-Null Count  Dtype  
#  ---  ------     --------------  -----  
