...
#  PIPELINE_START
pipeline = chain(
	query(condition="geonombreFundar=='Santa Cruz'"),
...
#  |     | geocodigoFundar   | geonombreFundar   |   anio | exportaciones   |   fob |
#  |----:|:------------------|:------------------|-------:|:----------------|------:|
#  | 200 | AR-Z              | Santa Cruz        |   1998 | mineras         | 20270 |
#  
#  ------------------------------
#  
#  rename_cols(map={'exportaciones': 'indicador', 'fob': 'valor'})
...
#  |----:|:------------------|:------------------|-------:|:------------|--------:|
#  | 200 | AR-Z              | Santa Cruz        |   1998 | Mineras     | 0.02027 |
#  
#  ------------------------------
#  
#  str_to_title(col='indicador')
...
#  |    | geocodigoFundar   | geonombreFundar   |   anio | indicador   |   valor |
#  |---:|:------------------|:------------------|-------:|:------------|--------:|
#  |  0 | AR-Z              | Santa Cruz        |   1998 | Mineras     | 0.02027 |
#  
#  ------------------------------
#  