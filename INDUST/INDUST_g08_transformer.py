...
#   5   importaciones    62090 non-null  float64
#   6   prop             61995 non-null  float64
#   7   source           62090 non-null  object 
#  
#  |    |   anio | geocodigoFundar   | geonombreFundar   | lall_code   | lall_desc_full                  |   importaciones |       prop | source         |
#  |---:|-------:|:------------------|:------------------|:------------|:--------------------------------|----------------:|-----------:|:---------------|
#  |  0 |   1988 | ABW               | Aruba             | mat         | Manufacturas de alta tecnología |          336219 | 0.00949233 | atlas_original |
#  
#  ------------------------------
#  
#  query(condition="anio == anio.max() & geocodigoFundar == 'ARG'")
...
#  |      |   anio | geocodigoFundar   | geonombreFundar   | lall_code   | lall_desc_full                  |   importaciones |    prop | source                 |
#  |-----:|-------:|:------------------|:------------------|:------------|:--------------------------------|----------------:|--------:|:-----------------------|
#  | 2366 |   2023 | ARG               | Argentina         | mat         | Manufacturas de alta tecnología |     9.62491e+09 | 15.1895 | proyeccion_indice_baci |
#  
#  ------------------------------
#  
#  multiplicar_por_escalar(col='prop', k=100)
