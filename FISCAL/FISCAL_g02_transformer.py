...
def custom_logic(df: DataFrame) -> DataFrame:
    df['categoria'] = df.apply(
        lambda row: row['region'] if row['geonombreFundar'] != 'Argentina'
        else 'Argentina', axis=1)
    return df
...
#   4   variable         292 non-null    object 
#   5   valor            292 non-null    float64
#   6   categoria        292 non-null    object 
#  
#  |    | geocodigoFundar   |   anio | geonombreFundar   | region   | variable                                                           |   valor | categoria   |
#  |---:|:------------------|-------:|:------------------|:---------|:-------------------------------------------------------------------|--------:|:------------|
#  |  0 | ALB               |   2023 | Albania           | Europa   | PIB per cápita PPP (en dólares internacionales constantes de 2021) | 17992.1 | Europa      |
#  
#  ------------------------------
#  
#  custom_logic()
