...
#  |     |   decil | codigo     |   desagregacion | gran_categoria             | categoria      | subcategoria              | rubro            | instrumento                         | variable                                                       |   valor |
#  |----:|--------:|:-----------|----------------:|:---------------------------|:---------------|:--------------------------|:-----------------|:------------------------------------|:---------------------------------------------------------------|--------:|
#  | 400 |       1 | 3.1.1.2.04 |               9 | Transferencias y subsidios | Transferencias | Transferencias monetarias | No contributivas | Asignación Universal por Hijo (AUH) | Incidencia fiscal respecto al ingreso de mercado más pensiones | 51.9047 |
#  
#  ------------------------------
#  