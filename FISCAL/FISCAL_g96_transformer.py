...
pipeline = chain(
	...
	query(condition="instrumento == 'Total – Subsidios'"),
	query(condition="variable == 'Incidencia fiscal respecto al ingreso de mercado más pensiones'")
)
#  PIPELINE_END
...
#  |     |   decil |   codigo |   desagregacion | gran_categoria             | categoria   | subcategoria   | rubro   | instrumento       | variable                                       |   valor |
#  |----:|--------:|---------:|----------------:|:---------------------------|:------------|:---------------|:--------|:------------------|:-----------------------------------------------|--------:|
#  | 810 |       1 |      3.2 |               2 | Transferencias y subsidios | Subsidios   |                |         | Total – Subsidios | Concentración per cápita (en dólares PPP 2011) | 127.944 |
#  
#  ------------------------------
#  
#  query(condition="variable == 'Incidencia fiscal respecto al ingreso de mercado más pensiones'")
#  Index: 10 entries, 820 to 829
#  Data columns (total 10 columns):
#   #   Column          Non-Null Count  Dtype  
#  ---  ------          --------------  -----  
...
#  |     |   decil |   codigo |   desagregacion | gran_categoria             | categoria   | subcategoria   | rubro   | instrumento       | variable                                                       |   valor |
#  |----:|--------:|---------:|----------------:|:---------------------------|:------------|:---------------|:--------|:------------------|:---------------------------------------------------------------|--------:|
#  | 820 |       1 |      3.2 |               2 | Transferencias y subsidios | Subsidios   |                |         | Total – Subsidios | Incidencia fiscal respecto al ingreso de mercado más pensiones | 77.1942 |
#  
#  ------------------------------
#  