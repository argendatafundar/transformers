...
pipeline = chain(
	...
	query(condition='exportaciones_en_usd_mill > 0')
)
#  PIPELINE_END
...
#   #   Column                     Non-Null Count  Dtype  
#  ---  ------                     --------------  -----  
#   0   categoria                  49 non-null     object 
#   1   anio                       49 non-null     int64  
#   2   exportaciones_en_usd_mill  49 non-null     float64
#   3   tipo                       49 non-null     object 
#   4   categoria2                 49 non-null     object 
#  
#  |    | categoria     |   anio |   exportaciones_en_usd_mill | tipo   | categoria2   |
#  |---:|:--------------|-------:|----------------------------:|:-------|:-------------|
#  |  0 | Complejo soja |   2024 |                     19628.1 | Bienes | Soja         |
