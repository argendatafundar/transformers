...
pipeline = chain(
	...
	query(condition="pais_nombre in ('Argentina', 'Yemen','Afganistán','Iraq','Siria','Mundo', 'India', 'Jordania', 'Suecia', 'América Latina y el Caribe', 'Noruega', 'Suiza', 'España', 'Italia', 'Brasil', 'Uruguay')")
)
#  PIPELINE_END
...
#  
#  query(condition="pais_nombre in ('Argentina', 'Yemen','Afganistán','Iraq','Siria','Mundo', 'India', 'Jordania', 'Suecia', 'América Latina y el Caribe', 'Noruega', 'Suiza', 'España', 'Italia', 'Brasil', 'Uruguay')")
#  Index: 32 entries, 28 to 10027
#  Data columns (total 5 columns):
#   #   Column       Non-Null Count  Dtype  
#  ---  ------       --------------  -----  
#   0   iso3         32 non-null     object 
#   1   anio         32 non-null     int64  
#   2   pais_nombre  32 non-null     object 
#   3   indicador    32 non-null     object 
#   4   valor        32 non-null     float64
#  
#  |    | iso3   |   anio | pais_nombre   | indicador   |   valor |
#  |---:|:-------|-------:|:--------------|:------------|--------:|
#  | 28 | AFG    |   2022 | Afganistán    | Varones     |   0.534 |
